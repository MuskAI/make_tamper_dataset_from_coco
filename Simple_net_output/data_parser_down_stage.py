...
from EightAndDualAttention.image_squeene import compress_image,get_size,MyGaussianBlur
import random
...
class DataParser():
    def __init__(self, batch_size_train):
        # self.edge_file = '/home/libiao/数据/12.29新八通道/gt'
        # self.train_file = '/home/libiao/数据/12.29新八通道/images'
        # self.double_edge_file='/home/libiao/数据/12.29新八通道/gt_countAndDegree'
        #
        # self.save_path0_1 = '/home/libiao/数据/12.29新八通道/e0_1'
        # self.save_path1_1 = '/home/libiao/数据/12.29新八通道/e1_1'
        # self.save_path01 = '/home/libiao/数据/12.29新八通道/e01'
        # self.save_path10 = '/home/libiao/数据/12.29新八通道/e10'
        # self.save_path11 = '/home/libiao/数据/12.29新八通道/e11'
        # self.save_path_1_1 = '/home/libiao/数据/12.29新八通道/e_1_1'
        # self.save_path_10 = '/home/libiao/数据/12.29新八通道/e_10'
        # self.save_path_11 = '/home/libiao/数据/12.29新八通道/e_11'

        # 1.06混合数据/media/yx/data1/李彪/1.11混合 数据/e0_1   /media/yx/data1/李彪/1.11混合数据/gt

        self.edge_file = '/home/libiao/数据/6.1混合数据/gt'
        self.train_file = '/home/libiao/数据/6.1混合数据/images'
        self.double_edge_file = '/home/libiao/数据/6.1混合数据/gt'
        ...
        self.edge_list = os.listdir(self.edge_file)
        ...
        print(len(self.trainimage_list))
    ...
    def get_batch(self, batch, train=True):
        ...
        for idx, b in enumerate(batch):
            if train:
                ...
                em = Image.open(self.Y_train[index])
                ...
                if im.size[0] > 320 and im.size[1] > 320:
                    ...
                    if random.randint(0, 1) == 0:
                        ...
                        em = em.crop((w_centry - 160 + range_w, h_centry - 160 + range_h, w_centry + 160 + range_w,
                                      h_centry + 160 + range_h))
                        dou_em = dou_em.crop((w_centry - 160 + range_w, h_centry - 160 + range_h, w_centry + 160 + range_w,
                                      h_centry + 160 + range_h))

                        chanel_1_1 = chanel_1_1.crop((w_centry - 160 + range_w, h_centry - 160 + range_h, w_centry + 160 + range_w,
                                      h_centry + 160 + range_h))
                        chanel_10 = chanel_10.crop((w_centry - 160 + range_w, h_centry - 160 + range_h, w_centry + 160 + range_w,
                                      h_centry + 160 + range_h))
                        chanel_11 = chanel_11.crop((w_centry - 160 + range_w, h_centry - 160 + range_h, w_centry + 160 + range_w,
                                      h_centry + 160 + range_h))
                        chanel0_1 = chanel0_1.crop((w_centry - 160 + range_w, h_centry - 160 + range_h, w_centry + 160 + range_w,
                                      h_centry + 160 + range_h))
                        chanel01 = chanel01.crop((w_centry - 160 + range_w, h_centry - 160 + range_h, w_centry + 160 + range_w,
                                      h_centry + 160 + range_h))
                        chanel1_1 = chanel1_1.crop((w_centry - 160 + range_w, h_centry - 160 + range_h, w_centry + 160 + range_w,
                                      h_centry + 160 + range_h))
                        chanel10 = chanel10.crop((w_centry - 160 + range_w, h_centry - 160 + range_h, w_centry + 160 + range_w,
                                      h_centry + 160 + range_h))
                        chanel11 = chanel11.crop((w_centry - 160 + range_w, h_centry - 160 + range_h, w_centry + 160 + range_w,
                                      h_centry + 160 + range_h))
                    else:
                        im = im.crop((w_centry - 160 - range_w, h_centry - 160 - range_h, w_centry + 160 - range_w,
                                      h_centry + 160 - range_h))
                        ...
                        try:
                            if random_aug < 5:
                                if random_aug == 0:
                                    ...
                                    em = em.transpose(Image.ROTATE_90)
                                    dou_em = dou_em.transpose(Image.ROTATE_90)
                                    chanel_1_1 = chanel_1_1.transpose(Image.ROTATE_90)
                                    chanel_10 = chanel_10.transpose(Image.ROTATE_90)
                                    chanel_11 = chanel_11.transpose(Image.ROTATE_90)
                                    chanel0_1 = chanel0_1.transpose(Image.ROTATE_90)
                                    chanel01 = chanel01.transpose(Image.ROTATE_90)
                                    chanel1_1 = chanel1_1.transpose(Image.ROTATE_90)
                                    chanel10 = chanel10.transpose(Image.ROTATE_90)
                                    chanel11 = chanel11.transpose(Image.ROTATE_90)
                                elif random_aug == 1:
                                    # 旋转180
                                    im = im.transpose(Image.ROTATE_180)
                                    em = em.transpose(Image.ROTATE_180)
                                    dou_em = dou_em.transpose(Image.ROTATE_180)
                                    chanel_1_1 = chanel_1_1.transpose(Image.ROTATE_180)
                                    chanel_10 = chanel_10.transpose(Image.ROTATE_180)
                                    chanel_11 = chanel_11.transpose(Image.ROTATE_180)
                                    chanel0_1 = chanel0_1.transpose(Image.ROTATE_180)
                                    chanel01 = chanel01.transpose(Image.ROTATE_180)
                                    chanel1_1 = chanel1_1.transpose(Image.ROTATE_180)
                                    chanel10 = chanel10.transpose(Image.ROTATE_180)
                                    chanel11 = chanel11.transpose(Image.ROTATE_180)
                                elif random_aug == 2:
                                    # 旋转270
                                    im = im.transpose(Image.ROTATE_270)
                                    em = em.transpose(Image.ROTATE_270)
                                    dou_em = dou_em.transpose(Image.ROTATE_270)
                                    chanel_1_1 = chanel_1_1.transpose(Image.ROTATE_270)
                                    chanel_10 = chanel_10.transpose(Image.ROTATE_270)
                                    chanel_11 = chanel_11.transpose(Image.ROTATE_270)
                                    chanel0_1 = chanel0_1.transpose(Image.ROTATE_270)
                                    chanel01 = chanel01.transpose(Image.ROTATE_270)
                                    chanel1_1 = chanel1_1.transpose(Image.ROTATE_270)
                                    chanel10 = chanel10.transpose(Image.ROTATE_270)
                                    chanel11 = chanel11.transpose(Image.ROTATE_270)
                                elif random_aug == 3:
                                    # 左右呼唤
                                    im = im.transpose(Image.FLIP_LEFT_RIGHT)
                                    em = em.transpose(Image.FLIP_LEFT_RIGHT)
                                    dou_em = dou_em.transpose(Image.FLIP_LEFT_RIGHT)
                                    chanel_1_1 = chanel_1_1.transpose(Image.FLIP_LEFT_RIGHT)
                                    chanel_10 = chanel_10.transpose(Image.FLIP_LEFT_RIGHT)
                                    chanel_11 = chanel_11.transpose(Image.FLIP_LEFT_RIGHT)
                                    chanel0_1 = chanel0_1.transpose(Image.FLIP_LEFT_RIGHT)
                                    chanel01 = chanel01.transpose(Image.FLIP_LEFT_RIGHT)
                                    chanel1_1 = chanel1_1.transpose(Image.FLIP_LEFT_RIGHT)
                                    chanel10 = chanel10.transpose(Image.FLIP_LEFT_RIGHT)
                                    chanel11 = chanel11.transpose(Image.FLIP_LEFT_RIGHT)
                                elif random_aug == 4:
                                    # 左右呼唤
                                    im = im.transpose(Image.FLIP_TOP_BOTTOM)
                                    em = em.transpose(Image.FLIP_TOP_BOTTOM)
                                    dou_em = dou_em.transpose(Image.FLIP_TOP_BOTTOM)
                                    chanel_1_1 = chanel_1_1.transpose(Image.FLIP_TOP_BOTTOM)
                                    chanel_10 = chanel_10.transpose(Image.FLIP_TOP_BOTTOM)
                                    chanel_11 = chanel_11.transpose(Image.FLIP_TOP_BOTTOM)
                                    chanel0_1 = chanel0_1.transpose(Image.FLIP_TOP_BOTTOM)
                                    chanel01 = chanel01.transpose(Image.FLIP_TOP_BOTTOM)
                                    chanel1_1 = chanel1_1.transpose(Image.FLIP_TOP_BOTTOM)
                                    chanel10 = chanel10.transpose(Image.FLIP_TOP_BOTTOM)
                                    chanel11 = chanel11.transpose(Image.FLIP_TOP_BOTTOM)
                ...
                # r, g, b = dou_em.split()
                # dou_em = np.array(g,dtype=np.float32)
                # dou_em = dou_em if dou_em.ndim == 2 else dou_em[:, :, 0]
        ...
        chanel1=np.asarray(chanel1)
        chanel2 = np.asarray(chanel2)
        chanel3 = np.asarray(chanel3)
        chanel4 = np.asarray(chanel4)
        chanel5 = np.asarray(chanel5)
        chanel6 = np.asarray(chanel6)
        chanel7 = np.asarray(chanel7)
        chanel8 = np.asarray(chanel8)
...
def generate_minibatches(dataParser, train=True):
    while True:
        if train:
            ...
            ims, ems,double_edge,chanel1,chanel2,chanel3,chanel4,chanel5,chanel6,chanel7,chanel8 ,chanel_fuse,edgemaps_4,edgemaps_8,edgemaps_16,_ = dataParser.get_batch(batch_ids)
        else:
            batch_ids = np.random.choice(dataParser.X_test, dataParser.batch_size)
            ims, ems, double_edge,chanel1,chanel2,chanel3,chanel4,chanel5,chanel6,chanel7,chanel8,chanel_fuse,edgemaps_4,edgemaps_8,edgemaps_16,_ = dataParser.get_batch(batch_ids,train=False)
